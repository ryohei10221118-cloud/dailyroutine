...
# 🚨 最優先規則（開始規劃前必讀！）
**⚠️ 一天只能使用一種標記為「⚠️酸類」或「⚠️刺激性」的產品！**
- 在規劃今日所有時段前，請先決定：今天要使用哪一種酸類/刺激性產品（只能選一種）
- 一旦選定，當天的所有其他時段都不可再使用任何其他酸類/刺激性產品
- 例如：如果決定今天使用「茶樹棉片 (⚠️刺激性)」，那麼當天就不能使用「硫磺精華 (⚠️刺激性)」或任何「⚠️酸類」產品
- 例如：如果已完成流程中使用了「水楊酸 Pad (⚠️酸類)」，剩餘時段只能使用溫和保濕產品
- **違反此規則可能造成肌膚嚴重受損！**
...
3. **🚨 刺激性產品與酸類使用規則（極度重要！違反可能造成肌膚受損！）**：
   ...
   - **茶樹棉片、硫磺精華都屬於刺激性產品，絕對不可同天使用**
   - 如果今日已完成的流程中使用了酸類/刺激性產品，剩餘時段必須避免使用任何酸類/刺激性產品
   - 酸類產品包括：水楊酸、果酸、A醇、杏仁酸等（產品清單中會標記「⚠️酸類」）
   - 刺激性產品包括：硫磺精華、茶樹棉片、高濃度酸類等（產品清單中會標記「⚠️刺激性」）
   - 使用酸類/刺激性產品的當天，其他時段改用溫和保濕產品
   - **禁止範例 1**：早上使用「茶樹棉片 (⚠️刺激性)」+ 晚上使用「硫磺精華 (⚠️刺激性)」❌
   - **禁止範例 2**：早上使用「水楊酸 Pad (⚠️酸類)」+ 晚上使用「硫磺精華 (⚠️刺激性)」❌
   - **正確範例**：早上使用「茶樹棉片 (⚠️刺激性)」，晚上只使用溫和的化妝水 + 精華液 + 乳液 ✅
4. **📍 使用部位限制（必須嚴格遵守！）**：
...
5. **⚠️ 產品使用邏輯與順序（非常重要！）**：
   ...
   - **面膜後的產品順序**：敷完面膜後，應使用輕薄的精華液或乳液鎖住水分，**不要使用精華油**（精華油質地厚重，會阻礙面膜精華吸收）
   - **精華液**：通常只需使用一種，除非是分區使用（例如眼部精華 + 臉部精華）
   - **精華油使用時機**：精華油應在**沒有敷面膜**的時候使用，且用量要少（1-2滴），主要用於極度乾燥時或作為最後一步鎖水
   - **乳液/面霜**：選其一即可，不要同時使用多種
   - **防曬**：只在白天出門前使用，睡前不使用
   - **正確產品順序**：
     - 一般流程：清潔 → 化妝水 → 精華液 → 乳液/面霜 → 防曬（日間）
     - 面膜流程：清潔 → 化妝水 → 面膜（15-20分鐘）→ 輕薄精華液或乳液 → ❌不要用精華油
     - 使用精華油：清潔 → 化妝水 → 精華液 → 精華油（1-2滴）→ 乳液（可選）
